...
class RateConfig
{
    ...
    {
        $this->id = 'app_global_limit';
        $this->policy = 'sliding_window';
        $this->limit = 150;
        $this->interval = '1 minute';
        $this->bucketResolverType = BaseBucketResolver::class;
        $this->connectionResolverType = IpGranularityResolver::class;
    }
